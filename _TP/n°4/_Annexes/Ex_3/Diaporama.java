...
// Annee 2008_2009 - Applications graphiques
//
...
public class EcouteurSouris implements MouseListener,
 ...
 //  
   public void charger(String nomFichier, String version) {
      images= (LinkedHashMap)Data.load(nomFichier, version);
   }  
   ...
   public static void main(String[] args) {
      ...
      //   	
      HashMap config= (HashMap) Config.load("ConfigDiaporamaG", "1.1.0");
      
      // Creer la fenetre de projection
      //
      Diaporama diaporama= new Diaporama(config);
      
      // Charger le diaporama
      //
      diaporama.charger("Fleurs", "1.0.0");

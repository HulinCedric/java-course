...
// Annee 2007_2008 - Gestion des fichiers de configuration
//
...
//    + Version 1.2.0  : une configuration peut deriver de la classe HashMap ou
//                       de la classe LinkedHashMap 
//    + Version 1.3.0  : chargement d'un fichier de configuration depuis le
//                       sous repertoire Config du repertoire courant, a defaut
//                       de le trouver dans ce dernier     
/**
 *
 ...
 *
 * load   : charger une configuration depuis le repertoire courant,
 * store  : enregistrer une configuration dans le repertoire courant.
 *
...
**/
   ...
   ObjectOutputStream out= null;
      ...
      if (origine != "java.util.HashMap" && 
          ...
          String parent= config.getClass().getSuperclass().getName();
          if (parent  != "java.util.HashMap" &&
              parent  != "java.util.LinkedHashMap") return false;
      }
...
**/
   ...
   Object resultat;
      ...
      if (origine != "java.util.HashMap" && 
          origine != "java.util.LinkedHashMap") { 
          String parent= resultat.getClass().getSuperclass().getName();
          if (parent  != "java.util.HashMap" &&
              parent  != "java.util.LinkedHashMap") return null;
      }

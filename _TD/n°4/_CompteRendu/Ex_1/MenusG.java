...
//                      des menus Word + Griser les items qui n'ont pas d'Žecouteur             
//    + Version 1.4.0 : ajout d'un getter priver sur les items            
//
...
private Frame hameconAmont;
   ...
   LinkedHashMap config;
      ...
      Frame f= new Frame();
      f.setSize(900, 500);
      f.setTitle ("(AWT) Test de la barre de menus generique - V 1.4.0");
      f.setLocation (0, 0);

...
//    + Version 2.3.0   : introduction d'un dictionnaire interne des items du 
//                        menu "Fichier"
//    + Version 2.4.0   : externalisation du menu "Fichier" dans une classe
//                        deportee
//    + Version 2.5.0   : signalement console de chaque activation d'un item
//                        du menu "Fichier"
//    + Version 2.6.0   : chaque item du menu "Fichier" visualise son label
//                        dans la console, lors de son activation
//
// Auteur : A. Thuaire
//
...
private Menu      menuFichier;
   ...
   public FenetreSaisieTexte() {
      ...
      //
      setSize(500, 200);
      setTitle ("(AWT) Fenetre de saisie de texte - V 2.6.0");
      setLocation (400, 300);
      ...
      menuFichier= new MenuFichier();                 // Menu "Fichier"

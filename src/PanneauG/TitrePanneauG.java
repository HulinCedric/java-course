...
//
// Classe TitrePanneauG - Titre textuel de toute instance de PanneauG
//
// Edition A    : Cours_10
//    + Version 1.0.0	: version initiale
//    + Version 1.1.0   : ajout accesseurs de consultation obtenirTexteTitre,
...
// ------                                               *** Constructeur normal
   ...
   public TitrePanneauG (PanneauG hamecon, String texte, 
                                           Color couleur, 
                                           Font police) {
...
// ------                                        *** Accesseurs de consultation
   ...
   public String obtenirTexteTitre   () {return texteTitre;}
   public Color  obtenirCouleurTitre () {return couleurTitre;}
   public Font   obtenirPoliceTitre  () {return policeTitre;}
...
// ------                                               *** Methode dessiner
   ...
   public void dessiner(Graphics g) {
      ...
      if (!panneau.presenceImage()) {
         ...
         //
   	     int abscisseCentre= panneau.getWidth()/2;
   	     int ordonneeCentre= panneau.getHeight()/2;
         
         // Dessiner le texte
         //        
         g.drawString(texteTitre, (largeurPanneau-largeurTitre)/2, 
                                  (hauteurPanneau-hauteurTitre)/2);
      }

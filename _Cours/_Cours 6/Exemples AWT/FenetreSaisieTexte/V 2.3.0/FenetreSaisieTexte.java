...
private LinkedHashMap itemsMenu;
   ...
   public FenetreSaisieTexte() {
      ...
      itemsMenu= new LinkedHashMap();                 // Dictionnaire des items
      ...
      Iterator i= itemsMenu.keySet().iterator();      // Installation des items
      MenuItem itemMenu;
      
      while (i.hasNext()) {
      	
         itemMenu= (MenuItem)itemsMenu.get(i.next());
         if (itemMenu == null) menuFichier.addSeparator();
         else menuFichier.add(itemMenu);
      }        

...
//    + Version 3.1.0   : possibilite de designer une maille au moyen d'un clic 
//                        souris (avec EcouteurPanneauG - V 1.1.0)
//    + Version 3.2.0   : modification du type de l'attribut hamecon pour 
//                        pouvoir inclure un panneau generique dans un autre
//                        panneau generique
//    + Version 3.3.0   ; ajout accesseurs de consultation suivants :
//                           + obtenirCheminImage,
//                           + obtenirTexteTitre, 
//                           + obtenirCouleurTitre,
//                           + obtenirPoliceTitre
...
// ------                                               *** Methode main
   ...
   public static void main(String[] args) {
      ...
      //
      panneau.ajouterImage("../_Images/Fleurs/Hibiscus.jpg");
      
      // Obtenir le chemin d'acces a l'image courante
      //
      String cheminImage= panneau.obtenirCheminImage();
      
      // Retirer l'image courante
      //
      panneau.retirerImage();
      
      // Ajouter a nouveau la meme image de fond
      //
      panneau.ajouterImage(cheminImage);
   ...
   // ------                                     *** Accesseurs de consultation
      ...
      public String obtenirCheminImage ()  {return image.obtenirCheminImage();} 
      public String obtenirTexteTitre  ()   {return titre.obtenirTexteTitre();}
      public Color  obtenirCouleurTitre() {return titre.obtenirCouleurTitre();}
      public Font   obtenirPoliceTitre ()  {return titre.obtenirPoliceTitre();}

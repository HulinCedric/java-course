...
//                        trame sous jacente
//    
//    + Version 1.7.0   : introduction de la possibilite de supprimer de facon 
//                        dynamique une des bordures d'une cellule cible de la 
//                        trame sous jacente
//
// Edition C    : exigences de dessin dans le gabarit d'une cellule
//
//    + Version 2.0.0	: possibilite de dessiner un label dans une cellule
//   
// Auteur : A. Thuaire
//
...
// ------                                        *** Accesseurs de modification
   ...
   public boolean ajouterComposant(int ligne, int colonne, 
      ...
      //
      Polygon rectangle= trame.obtenirRectangle(ligne, colonne);
...
// ------                                                      *** Methode main     
   ...
   Dimension gabarit;
      ...
      // Retirer les cellules (1, 1) et (1, 3)
      //
      calque_1.trame.retirerCellule(1, 1);
      calque_1.trame.retirerCellule(1, 3);
      
      // -- Ajouter un label dans la cellule (1, 2)
      //
      calque_1.ajouterComposant(1, 2, "SUD", "Joueur_1");
      
      //  Retirer la cellule (1, 2)
      //
      ...
      // Supprimer la bordure EST de la cellule (2, 1)
      //
      calque_1.trame.supprimerBordure(2, 1, "EST");
      
      // Supprimer la bordure OUEST de la cellule (2, 2)
      //
      calque_1.trame.supprimerBordure(2, 2, "OUEST");
   }

...
// ------                                                      *** Methode main     
   ...
   PanneauG panneau= null;
      ...
      f1.setTitle("(SWING) Classe CalqueG - V 0.2.0 (C1)");
      f1.setSize(500, 300);
      ...
      // Creer un premier calque avec le second constructeur normal
      //
      ...
      f2.setTitle("(SWING) Classe CalqueG - V 0.2.0 (C2)");
      f2.setSize(500, 300);
      ...
      // Creer un second calque avec le second constructeur normal
      //
      CalqueG calque_2= new CalqueG(f2, config_2, "Calque_B", "0.1.0");
      
      // Ajouter le nouveau calque au cadre support
      //

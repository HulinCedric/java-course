...
public class CadreG extends Frame {
   ...
   public CadreG (HashMap config) {
      ...
      //
      WindowAdapter ecouteurX= (WindowAdapter)config.get("ecouteur");
      addWindowListener (ecouteurX);  
   }
   ...
   public static void main(String[] args) {
      ...
      config.put("titre",       "(AWT) Classe CadreG - V 1.1.0");
      ...
      config.put("ecouteur",    new WindowAdapter() {	 

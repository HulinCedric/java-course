...
//
   ...
   LinkedHashMap config;
      ...
      Frame f= new Frame();
      f.setSize(700, 400);
      f.setTitle ("(AWT) Test de la barre de menus generique - V 1.5.0");
...
// --- Activer un item dans un menu cible             *** Methode activerItem
//   
...
// --- Desactiver un item dans un menu cible     *** Methode desactiverItem
//   

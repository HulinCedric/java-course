...
//                        + ajout de la methode obtenirPositionCelluleCible
//    + Version 2.2.0   : l'ecouteur designe la position relative du clic dans
//                        la cellule cible (classe EcouteurMosaiqueG - V 1.1.0)
//                        + ajout de la methode obtenirPositionRelativeCible
//    + Version 2.3.0   : introduction d'un maillage rectangulaire, regulier, 
//                        uniforme et couvrant (option) de toute la mosaique, 
//                        reactif aux actions operateur (option)
//
// Auteur : A. Thuaire
//
...
// ------                                      *** Premier constructeur normal
   ...
   public static void main(String[] args) {
      ...
      //   	
      JFrame f= new JFrame();
      f.setTitle("((SWING) Classe MosaiqueG - V 2.3.0");
      f.setSize(500, 300);
      ...
      // cellule cible et la position relative d'un clic souris
      //
      mosaique.ajouterEcouteur(new EcouteurMosaiqueG(mosaique));
      
      // Definir un maillage rectangulaire du panneau principal
      //
      mosaique.ajouterMaillage(Color.yellow, null, 10, 15);
...
// ------                                         *** Methode rassemblerImages
   ...
   // ------                        *** Methode obtenirPositionRelativeCible
      ...
      public Dimension obtenirPositionRelativeCible (int x, int y) {
         ...
         // Calculer les coordonnees relatives du clic dans la cellule cible
         //
